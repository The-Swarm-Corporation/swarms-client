...
__all__ = ["BatchCreateCompletionResponse", "BatchCreateCompletionResponseItem"]


class BatchCreateCompletionResponseItem(BaseModel):
...
BatchCreateCompletionResponse: TypeAlias = List[BatchCreateCompletionResponseItem]
