...
__all__ = ["BatchCreateCompletionParams", "InputSchema", "InputSchemaConfig"]


class BatchCreateCompletionParams(TypedDict, total=False):
    input_schemas: Required[Optional[Iterable[InputSchema]]]
...
class InputSchema(TypedDict, total=False):
    config: Required[Optional[InputSchemaConfig]]
    """The configuration for the advanced research"""
