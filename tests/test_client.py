...
class TestSwarmsClient:
    ...
    def test_hardcoded_query_params_in_url(self, client: SwarmsClient) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: SwarmsClient) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: SwarmsClient) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = SwarmsClient(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        non_strict_client = SwarmsClient(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_omit_retry_count_header(
        ...
        response = client.with_raw_response.get_root(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.with_raw_response.get_root(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncSwarmsClient:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncSwarmsClient) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncSwarmsClient) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncSwarmsClient(base_url=base_url, api_key=api_key, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        non_strict_client = AsyncSwarmsClient(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.with_raw_response.get_root()
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.with_raw_response.get_root(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.with_raw_response.get_root(extra_headers={"x-stainless-retry-count": "42"})
