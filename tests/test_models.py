...
from swarms_client._compat import PYDANTIC_V1, parse_obj, model_dump, model_json
from swarms_client._models import DISCRIMINATOR_CACHE, BaseModel, construct_type
...
def test_discriminated_union_case() -> None:
    ...
    m = construct_type(
        ...
        type_=cast(
            Any, Annotated[Union[ModelA, ModelB], PropertyInfo(discriminator="type")]
        ),
    )
